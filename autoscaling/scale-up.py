...
def print_output(appName, envName, instances, cpu_idle):
    print("Aplication "+ appName +" of environment "+ envName +" scaled up to "+ str(len(instances)) +" instance(s) with sucess")
...
def scale_up(envName, appName, region):
...
def main():
    ...
    scale_up(envName, appName, region)
